 ...
 * 
 */
public class DefectTrackerLayout {
	...
	public static void buildTitle(HSSFSheet worksheet, int startRowIndex, int startColIndex) {
		...
		cellTitle.setCellValue("Defects Report");
	...
	public static void buildHeaders(HSSFSheet worksheet, int startRowIndex, int startColIndex) {
		...
		headerCellStyle.setFillBackgroundColor(HSSFColor.CORAL.index);
		...
		cell3.setCellValue("Date Raised");
		cell3.setCellStyle(headerCellStyle);

		HSSFCell cell4 = rowHeader.createCell(startColIndex+3);
		cell4.setCellValue("Date Delivered");
